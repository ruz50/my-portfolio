    ...
    <div className='fixed top-0 right-0 w-11/12 -z-10 translate-y-[-80%]'> 
      ...
      <nav className='w-full sticky px-5 lg:px-8 xl:px-[8%] py-4 flex items-center justify-between z-50'>
        ...
        <div className='flex items-center gap-4'>
            ...
            <a href="#contact" className='hidden lg:flex items-center gap-3 px-10 py-2.5 border border-gray-500 rounded-full ml-4 font-Ovo'>Contact <Image src={assets.arrow_icon} className='w-3' alt='contact-logo'/></a>
        ...
        {/* Mobile menu */}
          ...
          <ul ref={sideMenuRef} className='flex md:hidden flex-col gap-4 py-20 px-10 fixed -right-64 top-0 bottom-0 w-64 z-50 h-screen bg-rose-50 transition duration-500'>
            <div className='absolute top-6 right-6' onClick={closeMenu}>
              <Image src={assets.close_black} alt='mobile-close-icon' className='w-5 cursor-pointer'/>
            </div>
